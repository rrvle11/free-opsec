...
for (let i = 0; i < 20; i++) {
    ...
    console.log('%cIf you know exactly what you\'re doing, you should consider contributing to noskid. https://github.com/dpipstudio/noskid.today.', 'color: white; font-size: 18px;');
}
